...
url = "https://travel.qunar.com/travelbook/list/%25E5%258C%2597%25E4%25BA%25AC/hot_heat/1.htm"
...
for i in range(1,pageNum):
    print("正在爬取",str(i),"页........")
    url = "https://travel.qunar.com/travelbook/list/%25E5%258C%2597%25E4%25BA%25AC/hot_heat/" + str(i) + ".htm"
    bs = BeautifulSoup(html, "html.parser")
