...
url = "https://travel.qunar.com/travelbook/list/%25E8%25A5%25BF%25E5%25AE%2589/hot_heat/1.htm"
...
for i in range(1,pageNum):
    print("正在爬取",str(i),"页........")
    url = "https://travel.qunar.com/travelbook/list/%25E8%25A5%25BF%25E5%25AE%2589/hot_heat/" + str(i) + ".htm"
    bs = BeautifulSoup(html, "html.parser")
