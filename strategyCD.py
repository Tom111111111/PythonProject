...
url = "https://travel.qunar.com/travelbook/list/%25E6%2588%2590%25E9%2583%25BD/hot_heat/1.htm"
...
for i in range(1,pageNum):
    print("正在爬取",str(i),"页........")
    url = "https://travel.qunar.com/travelbook/list/%25E6%2588%2590%25E9%2583%25BD/hot_heat/" + str(i) + ".htm"
    bs = BeautifulSoup(html, "html.parser")
