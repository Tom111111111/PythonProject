...
url = "https://travel.qunar.com/travelbook/list/%25E9%25A6%2599%25E6%25B8%25AF/hot_heat/1.htm"
...
for i in range(1,pageNum):
    print("正在爬取",str(i),"页........")
    url = "https://travel.qunar.com/travelbook/list/%25E9%25A6%2599%25E6%25B8%25AF/hot_heat/" + str(i) + ".htm"
    bs = BeautifulSoup(html, "html.parser")
